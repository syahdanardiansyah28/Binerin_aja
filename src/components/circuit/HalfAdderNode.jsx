...
export default function HalfAdderNode({ data }) {
  return (
    <div className="min-w-[154px] rounded border border-cyan-300/40 bg-slate-950/90 p-3 text-cyan-100 shadow-neon">
      <Handle className="!h-3 !w-3 !border-cyan-100 !bg-cyan-300" type="target" position={Position.Left} id="a" style={{ top: '35%' }} />
      <Handle className="!h-3 !w-3 !border-cyan-100 !bg-cyan-300" type="target" position={Position.Left} id="b" style={{ top: '65%' }} />
      <p className="font-mono text-xs uppercase tracking-[0.18em] text-cyan-200/70">Half Adder</p>
