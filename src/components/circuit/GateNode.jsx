...
export default function GateNode({ data }) {
  ...
  return (
    <div className="min-w-[168px] rounded-lg border border-linear-border/70 bg-linear-surface p-3 text-center text-linear-text shadow-hairline">
      ...
      <p className="mt-2 rounded-md border border-linear-border/70 bg-linear-surface2 px-2 py-1 font-mono text-sm">
        OUT: {data.value ?? '-'}
      </p>
