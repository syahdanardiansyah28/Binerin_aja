...
export default function GateSymbol({ gate }) {
  ...
  return (
    <svg className="h-20 w-full" viewBox="0 0 220 110" role="img" aria-label={`${gate} symbol`}>
      ...
      <g stroke="#828FFF" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" fill="none">
        {gate === 'NOT' ? (
          <>
            <path d="M24 55 H62" />
            <path d="M62 24 L62 86 L134 55 Z" fill="rgba(94,106,210,0.12)" />
            <circle cx="146" cy="55" r="10" fill="#0F1011" />
            <path d="M156 55 H198" />
          </>
        ) : (
          <>
            ...
            {['AND', 'NAND'].includes(gate) && (
              <path d="M66 22 H108 Q150 22 150 55 Q150 88 108 88 H66 Z" fill="rgba(94,106,210,0.12)" />
            )}

            {isOrFamily && (
              <>
                {isXorFamily && <path d="M54 24 Q76 55 54 86" />}
                <path d="M66 22 Q112 22 150 55 Q112 88 66 88 Q88 55 66 22 Z" fill="rgba(94,106,210,0.12)" />
              </>
            )}

            {hasBubble && <circle cx={gate === 'NAND' ? 162 : 162} cy="55" r="10" fill="#0F1011" />}
          </>
        )}
      </g>

      <g fontFamily="SF Mono, Monaco, Consolas, monospace" fontSize="10" fill="#B4BCD0">
